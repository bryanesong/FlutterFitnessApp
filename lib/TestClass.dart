...
enum CalorieTrackerState { log, addFood, myFood, searchFood, addMyFood }
...
class TestClassState extends State<TestClass> {
  ...
  Widget getContainer() {
    switch (_calorieState) {
      ...
      case CalorieTrackerState.addFood:
                    ...
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              print("tapped on index " + index.toString());
                            },
                            child: Container(
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
